...
public class RenderUtils
{
    ...
    public static Vec3d worldSpaceToScreenSpace(Vec3d position)
    {
    ...
    private static void renderRoundedBox(Matrix4f matrixStack, float red, float green, float blue, float alpha,
                                         double startX, double startY, double endX, double endY, double radiusCorner1,
                                         double radiusCorner2, double radiusCorner3, double radiusCorner4, int samples)
    {
    ...
    public static void renderRoundedBox(MatrixStack matrixStack, RGBAColor rgbaColor, double xStart, double yStart,
                                        double xEnd, double yEnd, double radiusCorner1, double radiusCorner2,
                                        double radiusCorner3, double radiusCorner4, int samples)
    {
        ...
        RenderSystem.setShader(MinecraftClient.getInstance().getShaderLoader()
            .getOrCreateProgram(ShaderProgramKeys.POSITION_COLOR));
    ...
    public static void renderRoundedBox(MatrixStack matrixStack, RGBAColor rgbaColor, double xStart, double yStart,
                                        double xEnd, double yEnd, double radius, int samples)
    {
